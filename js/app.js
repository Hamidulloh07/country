...
let elBtnDrk = document.querySelector(".hero__button");
elBtnDrk.addEventListener("click" , function() {
...
let elSiteList = document.querySelector(".hero__list");
...
for (let count of countrys) {
  ...
  elText1.setAttribute("class", "pcolor") 
  ...
  elItem.className = "mb-5 shadow rounded hero__item"
